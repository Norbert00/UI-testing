...
public class PropertiesLoader {
    ...
    public Properties getPropertiesFromFile(String propertiesFileName) {
        ...
        try {
            LoggerManager.setLoggerInfo("Trying to load properties with file name: " + propertiesFileName);
            inputStream = getClass().getClassLoader().getResourceAsStream(propertiesFileName);

            if (inputStream != null) {
                properties.load(inputStream);
                LoggerManager.setLoggerInfo("Successfully loaded properties for file: " + propertiesFileName);
            } else {
